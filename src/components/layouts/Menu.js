                ...
                <nav className="navbar navbar-light bg-dark">
                    <div className="container">
                        ...
                        <div className="navbar-header">
                            <NavLink to={login ? "/loginSuccess" : "/"}><i className="navbar-brand text-white text-lg brand-text" >Kwarantanna App</i></NavLink>
                        </div>

                        <ul className="navbar-nav ml-auto text-light d-inline-block col-md-8">
                            <li className="nav-item d-inline-block mr-5 h4">
